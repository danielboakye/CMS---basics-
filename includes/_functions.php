...
function connect_to_db($config){
	try {
		...
		return $con;
		//should the connection be closed after use
...
function insertQuery($query, $bindings, $con){
	...
	try {
		...
		// $myQuery->bindParam(':menu_name', $bindings['menu_name']);
		// $myQuery->bindParam(':position', $bindings['position']);
		// $myQuery->bindParam(':visible', $bindings['visible']);
		// if(isset($bindings['content']) && isset($bindings['subject_id']) )
		// {
		// 	$myQuery->bindParam(':subject_id', $bindings['subject_id']);
		// 	$myQuery->bindParam(':content', $bindings['content']);
		// }
